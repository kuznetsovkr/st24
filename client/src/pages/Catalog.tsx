          ...
          {categories.map((category) => (
            <Link key={category.slug} to={`/catalog/${category.slug}`} className="card category-card">
              ...
              <div className="category-image">
                {category.image ? <img src={category.image} alt={category.name} /> : <span>Фото</span>}
              </div>
            </Link>
          ))}
        </div>
